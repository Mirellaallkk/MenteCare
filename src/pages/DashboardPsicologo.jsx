    ...
    <div className="space-y-6">
      ...
      {isNewPsychologist && (
        <Card className="text-center py-8 border-2 border-dashed border-light/30">
          ...
          <h3 className="text-xl font-semibold text-dark mb-2">Bem-vindo ao MenteCare!</h3>
