...
export const ChatIA = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-black mb-2">Chat com IA</h1>
      </div>

      <div className="h-[600px] flex flex-col rounded-2xl bg-accent shadow-lg p-6 ">
        {/* Messages Area */}
        <div className="flex-1 overflow-y-auto p-6 space-y-4  text-light ">
          {messages.map((message) => (
            ...
            >
              <div className={`flex items-start space-x-3 max-w-[80%] ${message.type === 'user' ? 'flex-row-reverse space-x-reverse ' : ''
                ...
                <div className={`w-20 h-20 rounded-full flex items-center justify-center ${message.type === 'user'
                  ? 'bg-light text-white'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            ...
            <button
              ...
              className="text-left p-3 bg-accent border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-light transition-colors"
              disabled={isLoading}
            >
