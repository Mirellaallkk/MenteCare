    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-3">
                <Bell className="w-8 h-8 text-dark" />
                <h1 className="text-3xl font-bold text-black">Solicitações de Atendimento</h1>
            </div>

            <div className="grid gap-6">

                {requests.length === 0 ? (
                    <Card className="text-center py-12 !bg-[#d5caff]">
                    ...
                    requests.map(request => (
                        <Card key={request.id} className="space-y-4 !bg-[#d5caff]">
