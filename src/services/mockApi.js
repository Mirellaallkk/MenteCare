 ...
 */
  ...
  */
 const STORAGE_KEYS = {
   USERS: 'MenteCare_users',           // Usuários do sistema (psicólogos e pacientes)
   PATIENTS: 'MenteCare_patients',     // Dados detalhados dos pacientes
   APPOINTMENTS: 'MenteCare_appointments', // Agendamentos e sessões
   REQUESTS: 'MenteCare_requests'      // Solicitações de novos pacientes
 };
 ...
 const initialPatients = [
   ...
   { 
     id: 8, 
     name: 'Ana Cavalho', 
     email: 'claracarvalhooh@email.com', 
     phone: '(11) 99999-8888', 
 ...
 const initialRequests = [
   {
     id: 1,
     patientName: 'Clara Carvalho',
     patientEmail: 'claracarvalhooh@email.com',
     patientPhone: '(11) 99999-1111',
     preferredPsychologist: 2, // Dra. Ana Costa (TCC)
     description: 'Boa tarde! Eu gostaria de ser sua paciente. Fico muito ansiosa, estressada, sentimentos de solidão. Isso me atrapalha. Acho que preciso de ajuda. .',
     urgency: 'media',
